...
--
-- Table structure for table `tbl_estados_inventarios`
--

DROP TABLE IF EXISTS `tbl_estados_inventarios`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_estados_inventarios` (
  `ESIN_ID` int(11) NOT NULL AUTO_INCREMENT,
  `ESIN_NOMBRE` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ESIN_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_estados_inventarios`
--

LOCK TABLES `tbl_estados_inventarios` WRITE;
/*!40000 ALTER TABLE `tbl_estados_inventarios` DISABLE KEYS */;
INSERT INTO `tbl_estados_inventarios` VALUES (3,'Activo'),(4,'Inactivo');
/*!40000 ALTER TABLE `tbl_estados_inventarios` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tbl_invetarios` (
  ...
  `ESIN_ID` int(11) DEFAULT NULL,
  `PROD_ID` int(11) NOT NULL,
  PRIMARY KEY (`INVE_ID`),
  KEY `fk_TBL_INVETARIOS_TBL_PRODUCTOS1_idx` (`PROD_ID`),
  KEY `FK_TBL_INVENTARUIS_TBL_ESTADO_INVENTARIOs_idx` (`ESIN_ID`),
  CONSTRAINT `FK_TBL_INVENTARIOS_TBL_ESTADO_INVENTARIOS` FOREIGN KEY (`ESIN_ID`) REFERENCES `tbl_estados_inventarios` (`ESIN_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  CONSTRAINT `fk_tbl_inventarios_tbl_estainventarios` FOREIGN KEY (`ESIN_ID`) REFERENCES `tbl_estados_inventarios` (`ESIN_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_productos` VALUES (1,'PAPA',NULL),(2,'DETODITO',NULL),(3,'GALLETA',NULL),(4,'chess tress','2018-05-01'),(5,'doritos',NULL),(6,'galletas chokis',NULL),(7,'tostadas',NULL),(8,'tosti arepas',NULL);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `productosNotInventario` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `productosNotInventario`()
BEGIN
 select * from tbl_productos where PROD_ID NOT IN (SELECT PROD_ID from tbl_invetarios);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2017-06-04 19:56:26
