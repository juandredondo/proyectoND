...
CREATE TABLE `tbl_detallepedido` (
  ...
  PRIMARY KEY (`DEPE_ID`),
  KEY `fk_TBL_DETALLEPEDIDO_TBL_PRODUCTOS1_idx` (`PROD_ID`),
  ...
  CONSTRAINT `fk_TBL_DETALLEPEDIDO_TBL_PRODUCTOS1` FOREIGN KEY (`PROD_ID`) REFERENCES `tbl_productos` (`PROD_ID`) ON DELETE CASCADE ON UPDATE CASCADE
